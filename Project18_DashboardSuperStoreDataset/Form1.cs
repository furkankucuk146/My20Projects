...
namespace Project18_DashboardSuperStoreDataset
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=LAPTOP-B75NTCVD;initial catalog=Db17Project20;integrated security=true");
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            sqlConnection.Open();
            SqlCommand command7 = new SqlCommand("Select Order_Priority, Count(*) from superstore group by Order_Priority order by count(*) desc", sqlConnection);
