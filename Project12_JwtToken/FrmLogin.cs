...
namespace Project12_JwtToken
{
    public partial class FrmLogin : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=LAPTOP-B75NTCVD;initial catalog=Db12Project20;integrated security=true");
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtPassword.Clear();
                txtUserName.Clear();
                txtUserName.Focus();//imceli tekrar kullanıcı adına getirir
            }
            sqlConnection.Close();
        }
    }
