...
if (number == "1")
{
    string url = "https://localhost:7082/api/Weathers";
...
if (number == "4")
{
    string url = "https://localhost:7082/api/Weathers?id=";
...
if (number == "6")
{
    string url = "https://localhost:7082/api/Weathers/GetByIdWeatherCity?id=";
